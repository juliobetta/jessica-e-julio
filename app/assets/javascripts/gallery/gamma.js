  ...
  var $window = $( window ),
    ...
    _createSingleViewNavigation = function() {
      ...
      if( Gamma.itemsCount > 1 ) {
        ...
        Gamma.nav = $( '<nav class="gamma-nav"><span class="gamma-prev glyphicon glyphicon-chevron-left"></span><span class="gamma-next glyphicon glyphicon-chevron-right"></span></nav>' ).appendTo( Gamma.singleview );
